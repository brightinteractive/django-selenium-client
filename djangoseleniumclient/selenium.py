...
### This part is hard-coded in the XSL
    ...
    def get_boolean_array(self, verb, args):
        ...
        for i in range(len(boolarr)):
            boolstr = boolarr[i]      # Fix - TRC 19/05/10
            if ("true" == boolstr):
                boolarr[i] = True
                continue
            if ("false" == boolstr):
...
### From here on, everything's auto-generated from XML
    ...
    # Not here by default, added by TRC:
    def check_or_uncheck(self,locator,flag):
        """
        Check or uncheck a toggle-button (checkbox/radio), based on flag.
    ...
    def wait_for_page_to_load(self,timeout):
        ...
        'timeout' is a timeout in seconds, after which this command will return with an error
        """
